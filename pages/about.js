...
export default function About() {
  let { author, email, github, facebook, youtube, linkedin, twitter, image, siteUrl } = siteMetadata
  return (
    <>
      <PageSeo
        title={`About - ${author}`}
      ...
      <div className="divide-y">
        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center pt-8 space-x-2">
            <img src={image} alt="avatar" className="w-48 h-48 rounded-full" />
            ...
            <div className="flex pt-6 space-x-3">
              {email && <SocialIcon kind="mail" href={`mailto:${siteMetadata.email}`} />}
              {github && <SocialIcon kind="github" href={siteMetadata.github} />}
              {facebook && <SocialIcon kind="facebook" href={siteMetadata.facebook} />}
              {youtube && <SocialIcon kind="youtube" href={siteMetadata.youtube} />}
              {linkedin && <SocialIcon kind="linkedin" href={siteMetadata.linkedin} />}
              {twitter && <SocialIcon kind="twitter" href={siteMetadata.twitter} />}
